<template>
  <scroll-view scroll-y show-scrollbar="false" class="detail-page" :class="themeClass" :style="{ height: contentHeight }">
    <!-- 顶部导航栏 (模拟) -->
    ...
    <lk-modal v-model="showDescModal" title="Product Description">
      <text class="full-desc">
        This dress is crafted from premium sustainable cotton, offering a breathable and luxurious feel.
        Its minimalist design features a sleek silhouette, making it suitable for both casual outings and evening events.
        Care Instructions: Hand wash cold, do not bleach, iron on low heat.
      </text>
    </lk-modal>
  </scroll-view>
</template>
...
const activeTab = inject('activeTab', ref('detail'));
