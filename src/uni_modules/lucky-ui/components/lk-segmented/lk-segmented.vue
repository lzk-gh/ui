...
/* 监听 */
watch(() => props.modelValue, v => { active.value = v; updateSlider(); });
watch([() => props.options, () => props.size, () => props.block, () => props.inset, () => props.gutter],
      () => nextTick(updateSlider), { deep: true });
...
function updateSlider() {
  nextTick(() => {
    ...
    q.exec(res => {
      ...
      if (idx < 0 || !items[idx]) { sliderStyle.value.opacity = '0'; return; }
